...
def retrieve_countries(**kwargs):
    ...
    while index < len(countries):
        ...
        with open("/home/ubuntu/COVID-Tracker" + kwargs["path"] + "country" + str(file_num) + ".txt", "w+"):
            pass

        # Placing the appropriate date into the file
        with open("/home/ubuntu/COVID-Tracker" + kwargs["path"] + "country" + str(file_num) + ".txt", "a") as file:
...
def country_cases(**kwargs):
    ...
    with open("/home/ubuntu/COVID-Tracker" + kwargs["path"] + kwargs["filename"]) as file:
        for line in file:
            country = line.rstrip("\n")
